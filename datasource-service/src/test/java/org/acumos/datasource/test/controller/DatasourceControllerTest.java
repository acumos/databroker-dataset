...
public class DatasourceControllerTest {
	...
	public void getMetadata() {
		datasourceController = mock(DatasourceController.class);
		ResponseEntity<String> list = datasourceController.getMetadata(null, "datasourceKey");
		Assert.assertNull(list);
	}
	...
	public void getDataSourceSamples() {
		datasourceController = mock(DatasourceController.class);
		ResponseEntity<String> list = datasourceController.getDataSourceSamples(null, "dataSourcekey", null);
		Assert.assertNull(list);
	}
