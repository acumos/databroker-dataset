...
import org.acumos.service.controller.DatasourceFileController;
...
public class DatasourceFileControllerTest {
	...
	@Test
	public void getDataSourcesList() throws Exception {
		datasourceFileController = mock(DatasourceFileController.class);
		List<String> list = datasourceFileController.kerberosFileupload(null,null);
