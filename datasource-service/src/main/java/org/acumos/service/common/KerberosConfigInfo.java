...
public class KerberosConfigInfo {
	...
	/**
	 * @param kerberosKeyTabContent
	 *            the kerberosKeyTabContent to set
	 */
	...
	/**
	 * @param kerberosPasswordServer
	 *            the kerberosPasswordServer to set
	 */
	...
	/**
	 * @param kerberosRealms
	 *            the kerberosRealms to set
	 */
	...
	/**
	 * @param kerberosAdminServer
	 *            the kerberosAdminServer to set
	 */
