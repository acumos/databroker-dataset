...
import org.acumos.service.service.DataSourceServiceV2Impl;
...
public class DatasourceController {
	...
	@Autowired
	DataSourceServiceV2Impl service;
	...
	public Response getDataSource(@RequestHeader("Authorization") String authorization,
			@PathVariable (DATASOURCEKEY2) String datasourceKey) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = OK),
			...
			@ApiResponse(code = 500, message = INTERNAL_SERVER_ERROR) })
	@ResponseBody
	public Response getDataSourceContents(@RequestHeader("Authorization") String authorization,
			@RequestHeader("CodeCloud-Authorization") String codeCloudAuthorization,
	...
	@ResponseBody
	public Response getMetadata(@RequestHeader("Authorization") String authorization,
			@RequestHeader("CodeCloud-Authorization") String codeCloudAuthorization,
			@PathVariable(DATASOURCE_KEY) String dataSourceKey) {
	...
	@ApiResponses(value = {
			...
			response = DataSourceModel.class) })
	@ResponseBody
	public Response saveDataSourceDetail(@RequestHeader("Authorization") String authorization,
			@RequestHeader("CodeCloud-Authorization") String codeCloudAuthorization,
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = OK),
			...
			response = DataSourceModel.class) })
	@ResponseBody
	public Response updateDataSourceDetail(@RequestHeader("Authorization") String authorization,
			@RequestHeader("CodeCloud-Authorization") String codeCloudAuthorization,
			@PathVariable(DATASOURCE_KEY) String dataSourcekey, 
	...
	@ApiResponses(value = { @ApiResponse(code = 204, message = NO_CONTENT),
			...
			response = DataSourceModel.class) })
	@ResponseBody
	public Response deleteDataSourceDetail(@RequestHeader("Authorization") String authorization,
			@PathVariable(DATASOURCE_KEY) String datasourceKey) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = OK),
			...
			response = DataSourceModel.class) })
	@ResponseBody
	public Response validateDataSourceConnection(@RequestHeader("Authorization") String authorization,
			@RequestHeader("CodeCloud-Authorization") String codeCloudAuthorization,
			@PathVariable(DATASOURCE_KEY) String datasourceKey) {
	...
	@ResponseBody
	public Response getDataSourceSamples(@RequestHeader("Authorization") String authorization,
			@RequestHeader("CodeCloud-Authorization") String codeCloudAuthorization,
			@PathVariable(DATASOURCE_KEY) String dataSourceKey, 
			@RequestParam(HDFS_FILENAME) String hdfsFilename) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = CONNECTION_SUCCESS),
			...
			response = DataSourceModel.class) })
	@ResponseBody
	public Response writebackPrediction(@RequestHeader("Authorization") String authorization,
