...
public interface MongoDataSourceSvc {
	...
	public String getConnectionStatus_2_10(MongoDbConnectionModel objMongoDbConnectionModel, String query) throws UnknownHostException, IOException, CmlpDataSrcException;
	
	public MongoClient getConnection(MongoDbConnectionModel objMongoDbConnectionModel) throws UnknownHostException, IOException, CmlpDataSrcException;
