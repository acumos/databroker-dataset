...
public interface HdpBatchDataSourceSvc {
	...
	public String getConnStatusWithKerberos(KerberosLogin objKerberosLogin, String hostName, String hdfsFolderName) throws IOException, CmlpDataSrcException;

	public String getConnStatusWithKerberos(String hostName, String kerberosLoginuser, String hdfsFolderName) throws IOException, CmlpDataSrcException;
	...
	public InputStream getResults(String user, String authorization, String namespace, String datasourceKey, String batchSize) throws CmlpDataSrcException, IOException;
	...
	public DataSourceMetadata getMetadata(KerberosLogin objKerberosLogin, String hostName, String hdfsFolderName) throws CmlpDataSrcException, IOException;
