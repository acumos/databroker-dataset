...
public interface MySqlDataSourceSvc {
	...
	public String getConnectionStatus(MysqlConnectorModel objMysqlConnectorModel, String query) throws ClassNotFoundException, SQLException, IOException, CmlpDataSrcException;
	
	public Connection getConnection(String server, String port, String dbName, String username, String password) throws ClassNotFoundException, IOException, SQLException, CmlpDataSrcException;
	...
	public InputStream getSampleResults(DataSourceModelGet dataSource) throws IOException, ClassNotFoundException, SQLException, CmlpDataSrcException, ClassNotFoundException;
