...
public interface HdpDataSourceSvc {
	 ...
	 * Returns connection status for the given kerberos input parameters
	 */
	public String getConnStatusWithKerberos(KerberosLogin objKerberosLogin, String hostName, String hdfsFolderName,String readWriteDescriptor) throws IOException, DataSrcException;

	/**
	 * Returns connection status for the given kerberos input parameters
	 */
	public String getConnStatusWithKerberos(String hostName, String kerberosLoginuser, String hdfsFolderName,String readWriteDescriptor) throws IOException, DataSrcException;
	 ...
	 */
	public InputStream getResults(String user, String authorization, String namespace, String datasourceKey,String hdfsFilename) throws DataSrcException, IOException;

	/**
	 * Returns Sample Results for an existing datasource
	 */
	public InputStream getSampleResults(String user, String authorization, String namespace, String datasourceKey,String hdfsFilename) throws DataSrcException, IOException;
