...
public class HelperTool {
	...
	public long calculateJdbcResultSizeBySampling(ResultSet results) throws SQLException, DataSrcException {
	...
	public long calculateJdbcResultSizeByNotSampling(ResultSet results) throws SQLException, DataSrcException {
		long size = 0L;
