...
public class WebConfig {
	...
	@Value("${dataset_mongo_collection_name}")
	private String dataset_mongo_collection_name;
	...
	public DBCollection getDBCollection() throws IOException {
		...
		DB datasetDB = mongoClient.getDB(datasrc_mongo_dbname);

		return datasetDB.getCollection(dataset_mongo_collection_name);
	}
	...
	public DB getDatasetDB() throws IOException {
		...
		return mongoClient.getDB(datasrc_mongo_dbname);
	}
}
