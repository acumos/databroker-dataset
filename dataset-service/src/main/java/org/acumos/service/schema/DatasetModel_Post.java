...
public class DatasetModel_Post {
	...
	protected int noOfAttributes = 0; // 10 to 100, Less than 10, Greater than 100 - Columns
	protected DatasetAttributeMetaData attributeMetaData;
	protected List<DataSetKVPair> serviceMetaData; // key, value
	protected List<DataSetKVPair> customMetaData; // key, value
	
	
	public DatasetModel_Post() {
		super();
