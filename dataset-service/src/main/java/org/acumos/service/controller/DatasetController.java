...
public class DatasetController {
	...
	@ApiOperation(value = RESPOND_LIST_OF_DATASOURCES_ASSOCIATED_WITH_A_DATASET, notes = RETURNS_A_JSON_ARRAY_THAT_DENOTES_DATASOURCE_ASSOCIATED_WITH_A_DATASET, response = DatasetModel.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = A_SUCCESSFUL_RESPONSE_WITH_A_MESSAGE_BODY2),
			@ApiResponse(code = 400, message = BAD_REQUEST), @ApiResponse(code = 401, message = UNAUTHORIZED),
	...
	@ApiOperation(value = RESPOND_DATASOURCE_DETAILS_ASSOCIATED_WITH_A_DATASET, notes = RETURNS_A_JSON_STRING_THAT_DENOTES_DATASOURCE_DETAILS_ASSOCIATED_WITH_A_DATASET, response = DatasetModel.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = A_SUCCESSFUL_RESPONSE_WITH_A_MESSAGE_BODY2),
			@ApiResponse(code = 400, message = BAD_REQUEST), @ApiResponse(code = 401, message = UNAUTHORIZED),
			@ApiResponse(code = 403, message = FORBIDDEN), @ApiResponse(code = 404, message = NOT_FOUND),
			@ApiResponse(code = 500, message = INTERNAL_SERVER_ERROR) })
	...
	@ApiOperation(value = RETURNS_ATTRIBUTE_META_DATA, notes = RETURNS_A_JSON_ARRAY_OF_ATTRIBUTE_META_DATA_FOR_THE_GIVEN_DATASET, response = DataMetaDataInfo.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = A_SUCCESSFUL_RESPONSE_WITH_A_MESSAGE_BODY2),
			@ApiResponse(code = 400, message = BAD_REQUEST), @ApiResponse(code = 401, message = UNAUTHORIZED),
			@ApiResponse(code = 403, message = FORBIDDEN), @ApiResponse(code = 404, message = NOT_FOUND),
			@ApiResponse(code = 500, message = INTERNAL_SERVER_ERROR) })
	...
	@ApiOperation(value = RESPOND_CONTENTS_OF_DATASOURCE_ASSOCIATED_WITH_DATASET, notes = RETURNS_A_CHARACTER_STREAM_OF_DATA_FROM_THE_DATSOURCE_ASSOCIATED_WITH_A_DATASET, response = DataMetaDataInfo.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = A_SUCCESSFUL_RESPONSE_WITH_A_MESSAGE_BODY2),
			@ApiResponse(code = 400, message = BAD_REQUEST), @ApiResponse(code = 401, message = UNAUTHORIZED),
			@ApiResponse(code = 403, message = FORBIDDEN), @ApiResponse(code = 404, message = NOT_FOUND),
			@ApiResponse(code = 500, message = INTERNAL_SERVER_ERROR) })
