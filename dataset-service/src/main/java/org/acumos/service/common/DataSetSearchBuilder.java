...
public class DataSetSearchBuilder {
	...
	public static BasicDBObjectBuilder buildQueryForAdvancedSearch(String user, String datasetKey,
			DataSetSearchKeys searchKeys) {
	...
	public static DBObject createDBObject(DatasetModel_Get dataSet) {
	...
	public static void buildDataSetBuilder(DatasetModel_Get dataSet, BasicDBObjectBuilder dataSetBuilder) {
	...
	public static void setDatasetMetadata(DatasetModel_Get dataSet, BasicDBObjectBuilder dataSetBuilder) {
	...
	public static DBObject updateDBObject(DatasetModel_Get dataSet) {
		BasicDBObjectBuilder dataSetBuilder = BasicDBObjectBuilder.start();
