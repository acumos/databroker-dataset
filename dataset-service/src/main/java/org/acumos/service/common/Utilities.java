...
public class Utilities {
	...
	private static void findMissedParameters(DatasetModelGet dataset) throws CmlpDataSrcException {
	...
	private static void validateDatasetType(DatasetModelGet dataset) throws CmlpDataSrcException {
