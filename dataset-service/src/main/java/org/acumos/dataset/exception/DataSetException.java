...
public class DataSetException extends Exception {
	...
	public DataSetException(String Message, int code, DataSetRestError error) {
		super(Message);
	...
	public Response toResponse() {
		...
		if(_err == null) {
			_err = DataSetErrorList.buildError(new Exception("Unknown Error"), null, CmlpApplicationEnum.DATASET);
		}
	...
	public int getStatusCode() {
		return Status.fromStatusCode(_code).getStatusCode();
	}
