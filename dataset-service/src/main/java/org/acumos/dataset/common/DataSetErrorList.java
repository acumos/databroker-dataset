...
public class DataSetErrorList {

	private static Logger log = LoggerFactory.getLogger(DataSetErrorList.class);

	private DataSetErrorList() {
		super();
	}
	...
	public static DataSetRestError buildError(ErrorListEnum error, String[] errorVariables, String userMessage,
			CmlpApplicationEnum app) {

		DataSetRestError restError = new DataSetRestError();
	...
	public static DataSetRestError buildError(Exception sysException, ErrorListEnum error, CmlpApplicationEnum app) {
	...
	// another API call
	public static DataSetRestError buildError(String jsonStr, String backendName) {
		DataSetRestError restError = new DataSetRestError();
		try {
			if (jsonStr == null) {
