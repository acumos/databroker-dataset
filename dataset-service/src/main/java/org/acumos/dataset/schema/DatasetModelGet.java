...
public class DatasetModelGet extends DatasetModelPut {
	...
	public DatasetModelGet() {
		super();
	}
	
	public DatasetModelGet(DatasetModelPost post) {
	...
	public DatasetModelGet(DatasetModelPut put) {
